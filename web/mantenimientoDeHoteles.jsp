<%-- 
    Document   : mantenimientoDeHoteles
    Created on : Nov 15, 2013, 12:07:09 AM
    Author     : Andrea
--%>
...
<%
    ...
    request.getSession().removeAttribute("indexHotel");


    lstHotel = usuario.getLstHoteles();
    request.getSession().setAttribute("vieneDe", "mantenimiento");
%>
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
        <title>Mantenimiento de Hoteles</title>
        <style type="text/css">
            <!--
            body {
        ...
        <div class="container">
            ...
            <div class="content">
                ...
                <div id="botonesBusqueda">
                    ...
                    <p>
                        <input style="margin-left:180px" type="submit" name="btnBuscar" id="btnBuscar" value="Buscar" />
                    </p>
                    <p> 
                ...
                <div id="contenedorListaHoteles">
                    <p id="listaHoteles">
                        <form style=" padding: 20px" action="paginaHotel" method="post">
                            <%
                                for (Hotel h : usuario.getLstHoteles()) {
                                    out.println("<li><a href=\"paginaDeHotel.jsp?id=1&record=" + usuario.getLstHoteles().indexOf(h) + "\">" + h.getNombre() + "</a></li>");
                                    //request.getSession().setAttribute(h.getIdString(), h);
                                }
                            %>
                        </form>
                    </p>
