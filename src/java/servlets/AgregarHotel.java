...
public class AgregarHotel extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Hotel hotel = new Hotel(Integer.parseInt(estrellas), direccion, nombre, Integer.parseInt(id), Integer.parseInt(cupoTotal), direccion, horario);
            
            usuario.getLstHoteles().add(hotel);
